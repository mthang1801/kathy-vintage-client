...
} from './styles/CustomArrowSlider.styles';
...
export const CustomPortfoliosArrowPrev = (props) => {
  const { className, style, onClick } = props;
  return <CustomPortfoliosArrowPrevContainer onClick={onClick} />;
};
export const CustomPortfoliosArrowNext = (props) => {
  const { className, style, onClick } = props;
  return <CustomPortfoliosArrowNextContainer onClick={onClick} />;
};
